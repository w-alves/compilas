...
public class Interpreter implements Expr.Visitor<Integer> {
	...
	public final HashMap<String, String> id;

	public Interpreter(HashMap<String, String> id){this.id = id;}
	...
	public Integer visitNumberExpr(Expr.Number expr) {return Integer.parseInt(expr.value);}

	@Override
	public Integer visitExprId(Expr.Id expr){
		return Integer.parseInt(id.get(expr.value));
	}
